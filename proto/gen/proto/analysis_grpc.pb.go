...
const (
	AnalysisService_AnalyzeBatch_FullMethodName = "/analysis.AnalysisService/AnalyzeBatch"
)
...
func (c *analysisServiceClient) AnalyzeBatch(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*BatchResponse, error) {
...
func (UnimplementedAnalysisServiceServer) AnalyzeBatch(context.Context, *BatchRequest) (*BatchResponse, error) {
...
func _AnalysisService_AnalyzeBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServiceServer).AnalyzeBatch(ctx, req.(*BatchRequest))
	}
